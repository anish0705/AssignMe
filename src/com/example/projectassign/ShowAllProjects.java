...
public class ShowAllProjects extends Activity {
	private ListView lv;
	MyAdapter adapter;
	...
	public class MyTask2 extends AsyncTask<String,Void,Void>
    {
		...
		protected Void doInBackground(String... params) {
			...
			try
            {
				sb = new StringBuilder(s.url+"get_all_projects/"+user_email);
		...
		protected void onPostExecute(Void result) {
			 ...
			 lv = (ListView) findViewById(R.id.listview);
		        adapter = new MyAdapter(ShowAllProjects.this,no_of_days,task_category,task_id,task_title);
