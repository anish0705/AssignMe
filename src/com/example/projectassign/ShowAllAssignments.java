...
public class ShowAllAssignments extends Activity {
	private ListView lv;
	MyAdapter adapter;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_show_all_assignments);
	...
	public class MyTask extends AsyncTask<String,Void,Void>
    {
		...
		protected Void doInBackground(String... params) {
			...
			try
            {
				sb = new StringBuilder(s.url+"get_all_assignments/"+user_email);
		...
		protected void onPostExecute(Void result) {
			 ...
			 lv = (ListView) findViewById(R.id.listview);
		        adapter = new MyAdapter(ShowAllAssignments.this,no_of_days,task_category,task_id,task_title);
